...
fn parse_v_else_variants() {
    let tpl =
        r#"<div><p v-if="x">A</p><p v-else-if="y">B</p><p v-elseif="z">C</p><p v-else>D</p></div>"#;
                ...
                Node::Element { attrs, .. } => {
                    if i == 0 {
                        assert!(
                            attrs
                                .iter()
                                .any(|a| a.kind == AttrKind::Directive && a.name == "if")
                        );
                    } else if i == 1 {
                        assert!(
                            attrs
                                .iter()
                                .any(|a| a.kind == AttrKind::Directive && a.name == "else-if")
                        );
                    } else if i == 2 {
                        assert!(
                            attrs
                                .iter()
                                .any(|a| a.kind == AttrKind::Directive && a.name == "elseif"
                                    || a.name == "else-if")
                        );
                    } else if i == 3 {
                        assert!(
                            attrs
                                .iter()
                                .any(|a| a.kind == AttrKind::Directive && a.name == "else")
                        );
                    }
                }
