...
impl EventBinder {
    ...
    pub fn on_click(&mut self, target_id: impl Into<String>, handler: EventHandler) {
        self.on(
            target_id,
            EventBinding::new(EventType::Click, "click").with_handler(handler),
        );
    }
    ...
    pub fn on_input(&mut self, target_id: impl Into<String>, handler: EventHandler) {
        self.on(
            target_id,
            EventBinding::new(EventType::Input, "input").with_handler(handler),
        );
    }
    ...
    pub fn on_change(&mut self, target_id: impl Into<String>, handler: EventHandler) {
        self.on(
            target_id,
            EventBinding::new(EventType::Change, "change").with_handler(handler),
        );
    }
    ...
    pub fn on_keypress(&mut self, target_id: impl Into<String>, handler: EventHandler) {
        self.on(
            target_id,
            EventBinding::new(EventType::KeyPress, "keypress").with_handler(handler),
        );
    }
    ...
    pub fn on_hover(&mut self, target_id: impl Into<String>, handler: EventHandler) {
        self.on(
            target_id,
            EventBinding::new(EventType::Hover, "hover").with_handler(handler),
        );
    }
...
mod tests {
    ...
    #[test]
    fn test_event_data() {
        let event = EventData::new(EventType::Click, "btn1").with_position(100.0, 50.0);
