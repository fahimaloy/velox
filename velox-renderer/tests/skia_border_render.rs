//! Integration test: render a border and verify PNG checksum.
//!
...
fn render_border_vnode_checksum() {
    ...
    let vnode = h(
        "div",
        vec![("style", "background-color:#FFFFFF;border:2px solid #FF0000")],
        vec![],
    );
    ...
    const EXPECTED_BORDER_CHECKSUM: u32 = 0x9c5d942f;
